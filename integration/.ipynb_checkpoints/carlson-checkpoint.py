...
rfv = jax.vmap(rf)
rdv = jax.vmap(rd)
rcpv = jax.vmap(rc_posy)
rjpv = jax.vmap(rj_posp)
rcnv = jax.vmap(rc_negy)
rjnv = jax.vmap(rj_negp)
rcv = jax.vmap(rc)
rjv = jax.vmap(rj)

rfv_fast = jax.vmap(rf_fast)
rdv_fast = jax.vmap(rd_fast)
rcpv_fast = jax.vmap(rc_posy_fast)
rjpv_fast = jax.vmap(rj_posp_fast)
rcnv_fast = jax.vmap(rc_negy_fast)
rjnv_fast = jax.vmap(rj_negp_fast)
rcv_fast = jax.vmap(rc_fast)
rjv_fast = jax.vmap(rj_fast)